...
function [awidth:0] gray2bin;
   ...
   wire wclk_rreset;   
   nvme_cdc cdc_rreset (.clk(wclk),.d(rreset),.q(wclk_rreset));
   assign wreset_int = wreset | wclk_rreset;
   ...
   wire rclk_wreset;   
   nvme_cdc cdc_wreset (.clk(rclk),.d(wreset),.q(rclk_wreset));
   assign rreset_int = rreset | rclk_wreset;
   ...
   always @*
     begin
        ...
        s2_rerr_d     = 1'b0; // placeholder for ECC or parity coverage
